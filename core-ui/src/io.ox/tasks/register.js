...
ui.createApp({
  ...
  load: () => manifests.manager.loadPluginsFor('io.ox/tasks').then(() => import('@/io.ox/tasks/main'))
})
...
ui.createApp({
  ...
  requires: 'tasks',
  refreshable: true,
  load: () => manifests.manager.loadPluginsFor('io.ox/tasks/detail').then(() => import('@/io.ox/tasks/detail/main'))
})
