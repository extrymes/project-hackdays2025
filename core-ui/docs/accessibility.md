...
An Accessibility Conformance Report is available as [HTML][acr-html] and in [OpenACR][acr-openacr] format.

# History

Date   | Version | Activity
-------| --------| -----------------------------------------------------------------------
Jul 23 | 8.15    | Added support for EN 301 549 to accessibility conformance report
Jun 23 | 8.14    | Added support for prefers-reduced-motion media query, supporting users with vestibular and attention deficit disorders
May 23 | 8.13    | Added functionality to allow users to undo accidentally sending emails for a user-configurable time frame
Nov 22 | 8.8     | Updated axe-core to 4.6 and fixed new found issues
Oct 22 | 8.7     | Fix flickering of portal widgets
Oct 22 | 8.7     | Improve color contrast in contact and mail dialog
Oct 22 | 8.6     | Improve color contrast of links in mails and focus styles in settings drop down
Sep 22 | 8.6     | Improve aria roles in launcher and what-new-dialog
Sep 22 | 8.6     | Improve color contrast in twitter portal widget and guided tours
Aug 22 | 8.5     | Fixed minor keyboard focus issues in calendar, tasks, chat and core
Aug 22 | 8.5     | Updated axe-core to 4.4 and fixed new found issues
Jul 22 | 8.4     | Published Accessibility Conformance Report in [OpenACR][acr-openacr] format
Jul 22 | 8.4     | Fixes various keyboard related issues in Mail, Upsell and Guided Tours
Apr 22 | 8.3     | Removed presentational SVGs from accessibility tree
Mar 22 | 8.2     | Fixed various issues in dropdowns, color picker and folder nodes for keyboard users
Feb 22 | 8.1     | Comprehensive accessibility review and updated Accessibility Conformance Report
...
Nov 17 | 7.10.0  | Mail threads expandables were implemented in an accessible manner
...
[acr-openacr]: ./accessibility/acr.yaml
[acr-html]: ./accessibility/acr.html
