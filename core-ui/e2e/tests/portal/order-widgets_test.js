...
Scenario('[C7493] Order widgets', async ({ I }) => {
  I.login('app=io.ox/portal')
  I.waitForApp()

  // check position before
  I.waitForText('Inbox', undefined, '.widgets .widget:nth-child(1) h2')
  I.waitForText('Appointments', 5, '.widgets .widget:nth-child(2) h2')
  ...
  I.waitForText('Inbox', 5, '.widgets .widget:nth-child(2) h2')
})

Scenario('[C7473] Drag some portal-tiles', async ({ I }) => {
  I.login('app=io.ox/portal')
  I.waitForApp()
