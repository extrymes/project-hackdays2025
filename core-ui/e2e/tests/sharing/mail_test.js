...
Scenario('[C83383] mail folders using “Permissions” dialog', async ({ I, users, dialogs }) => {
  const busystate = locate('.modal modal-body.invisible')
  // Alice shares a mail folder
  I.login('app=io.ox/mail')
  I.waitForText('Spam', 5, '~Spam')
  I.selectFolder('Spam')
  ...
  I.waitForText('Spam', 10, '.folder-tree [data-id="default0/shared"]')
})
