...
const settings = require('../../../../pageobjects/fragments/settings')
...
Scenario('[C7873] Configure incoming invitation mails to be deleted after accepting or declining', async ({ I, users }) => {
