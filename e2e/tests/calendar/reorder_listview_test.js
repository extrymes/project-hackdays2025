...
Scenario('Reorder appointments with labels in list view', async ({ I, calendar }) => {
  /*
  ...
  const listItemSelector = (type, index) => {
    return locate(`.list-view .list-item:nth-child(${index + 1}).${type}`).as(`${index}. list item x(${type})`)
  }

  await I.haveAppointment({
    summary: 'Appointment 1',
    startDate: { value: refDate.clone() },
    endDate: { value: refDate.clone().add(2, 'hour') }
  })
  await I.haveAppointment({
    summary: 'Appointment 2',
    startDate: { value: refDate.clone().add(2, 'day').add(2, 'hour') },
    endDate: { value: refDate.clone().add(2, 'day').add(4, 'hour') }
  })
  await I.haveAppointment({
    summary: 'Appointment 3',
    startDate: { value: refDate.clone().add(4, 'day').add(6, 'hour') },
    endDate: { value: refDate.clone().add(4, 'day').add(8, 'hour') }
  })
  await I.haveAppointment({
    summary: 'Appointment 4',
    startDate: { value: refDate.clone().add(6, 'day').add(8, 'hour') },
    endDate: { value: refDate.clone().add(6, 'day').add(10, 'hour') }
  })
  await I.haveAppointment({
    summary: 'Appointment 5',
    startDate: { value: refDate.clone().add(8, 'day').add(10, 'hour') },
    endDate: { value: refDate.clone().add(8, 'day').add(12, 'hour') }
  })

  await I.haveSetting('io.ox/calendar//layout', 'list')
  ...
  I.see('Appointment 1', listItemSelector('appointment', 2))
  I.waitForText(refDate.clone().add(1, 'day').format('l'))
  ...
  I.see('Appointment 2', listItemSelector('appointment', 4))
  I.waitForText(refDate.clone().add(3, 'day').format('l'))
  ...
  I.see('Appointment 5', listItemSelector('appointment', 10))
  I.waitForText(refDate.clone().add(9, 'day').format('l'))
  ...
  I.waitForText(refDate.clone().add(4, 'day').format('l'))
  ...
  I.waitForText(refDate.clone().add(5, 'day').format('l'))
  ...
  I.waitForFocus(`.folder [data-id="${folder}"]`)
  I.waitNumberOfVisibleElements('.list-view .list-item-label', 4)
