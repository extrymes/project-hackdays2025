...
// - checkmarkFn (function): when provided, a check mark design is used for the entry - the callback return value determines the state

const ActionDropdownView = DisposableView.extend({
...
export default ActionDropdownView
