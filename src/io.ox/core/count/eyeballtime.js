...
import isActive from '@/io.ox/core/active'
import ox from '@/ox'
...
if (!api.disabled) {
  ...
  function getCurrentApp () {
    const app = ox.ui.App.getCurrentFloatingApp() || ox.ui.App.getCurrentApp()
    return app ? app.get('name') : ''
  }

  function send (app) {
    api.add('ebt', { app, uuid: api.uuid, t0: ox.t0, d: api.device })
  }
