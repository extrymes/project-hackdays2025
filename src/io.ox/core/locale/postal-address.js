...
function getAddress (data, type, cc) {
  const street = data['street_' + type] || ''
  const code = data['postal_code_' + type] || ''
  const city = data['city_' + type] || ''
  const state = data['state_' + type] || ''
  const country = data['country_' + type] || ''
  ...
  switch (cc) {
    // without 'state'
    case 'DE':
      return street + LF + code + _ + city + LF + country
    case 'AR':
    case 'AT':
    case 'BO':
    case 'CH':
    ...
    case 'NO':
    case 'SE':
      return street + LF + code + _ + city + _ + state + LF + country
    case 'AU':
    case 'CA':
    case 'PR':
    case 'US':
    case 'TW':
      return street + LF + city + _ + state + _ + code + LF + country
    case 'IE':
    case 'GB':
    case 'RU':
      return street + LF + city + LF + state + _ + code + LF + country
    case 'NZ':
    case 'SG':
      return street + LF + city + _ + code + _ + state + LF + country
    case 'CN':
      return street + _ + city + LF + code + _ + state + LF + country
    case 'CR':
      return street + LF + city + _ + state + LF + code + _ + country
    case 'JP':
      return street + LF + state + _ + city + _ + code + LF + country
    case 'MX':
      return street + LF + city + LF + code + _ + state + LF + country
    case 'NL':
      return street + LF + code + _ + state + _ + city + LF + country
    case 'ZA':
      return street + LF + city + LF + state + LF + code + _ + country
    case 'RO':
    default:
      return street + LF + code + _ + city + LF + state + LF + country
  }
}
