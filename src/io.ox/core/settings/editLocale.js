...
const POINT = 'io.ox/core/settings/edit-locale'
let INDEX = 0
...
function openModalDialog () {
  return new ModalView({
    ...
    .on('save', function () {
      const changed = this.model.changedAttributes(this.initial)
      if (!changed) return
...
export default { open: openModalDialog }
