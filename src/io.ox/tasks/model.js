...
import Validations from '@/io.ox/backbone/validation'
...
const factory = new ModelFactory({
  ...
  model: {
    ...
    getParticipants () {
      ...
      let changeParticipantsUpdate = false
    ...
    getDate (attribute, options) {
      let time = this.get.apply(this, arguments)
      options = options || {}
...
ext.point('io.ox/tasks/model/validation').extend({
  ...
  validate (attributes) {
    const tCosts = String(attributes.target_costs)
    const aCosts = String(attributes.actual_costs)
